...
def plot_timeseries(
    ...
    if resample:
        ...
        returns = returns.last() if compound is True else returns.resample(resample).sum()
        if isinstance(benchmark, _pd.Series):
            benchmark = benchmark.resample(resample)
            benchmark = benchmark.last() if compound is True else benchmark.resample(resample).sum()
    # ---------------
